...
<head>
    ...
    <title>Webflix - Multimedia</title>
    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            <div class="card h-100">
                ...
                <div class="card-body">
                    <h4 class="card-title"><%= multimediaContent.getTitle() %>
                    </h4>
                    <h5><%= multimediaContent.getDirectorName() %>
                    </h5>
                    <p class="card-text"><%= multimediaContent.getYearOfRelease() %>
                    </p>
                    <p class="card-text"><%= multimediaContent.getCategory().getCategory() %>
                    </p>
                ...
                <div class="card-footer">
                    ...
                    <div class="row">
                        ...
                        %>
                        <div class="col-lg-1">
                            <form id="deleteContent" method="POST" name="deleteContent"
                                  action="${contextRoot}/multimedia/deleteContent">
                        ...
                        <div class="col-lg-1">
                            <a href="${contextRoot}/multimedia/editContent?id=<%= multimediaContent.getId() %>"
