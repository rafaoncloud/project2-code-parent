...
<html lang="en">
  ...
  <head>
    ...
    <title>Webflix - Edit Account</title>
                    ...
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" name="creditCardNumber" id="creditCardNumber"  value='<%=request.getAttribute("creditCardNumber")%>' placeholder="Your Credit Card Number" required/>
                            </div>
                        </div>
                    </div>
