...
public class MultimediaContent {
    ...
    public Response getMultimediaContentByCategory(@NotNull @QueryParam("token") final String token,
        ...
        try {
           // List<dto.MultimediaContent> contentList = multimediaContentEJB.getMultimediaContentFromCategory(token,dto.MultimediaContentCategory.valueOf(category.toUpperCase()),isOrderAsc);
            return null;//Response.ok(contentList).build();
        } catch (Exception e) {
            e.printStackTrace();
        }
