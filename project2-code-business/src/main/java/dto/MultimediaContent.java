...
//    public MultimediaContent(long id, String contentPath, String title, MultimediaContentCategory category, int yearOfRelease, String directorName,
//                             List<User> users,Date createdOn) {
//        this.id = id;
//        this.contentPath = contentPath;
//        this.title = title;
//        this.category = category;
